# ThreatModellingWorkshopProject# AI Threat Modelling Workshop Summary (Simulation)
## Introduction
A threat modelling workshop took place to detail the runbook scenario of multiple AI attacks against the, simulated web-facing health care application Solaris Care Connect 360.
## Attendess
Care Connect Engineering team, Product Managers, DevEx Engineers and the DevSecOps Team.
## Scope
Four Scenarios were run covering:
...
## Methodology
Each of the scenarios were run against the cyber attack killchain, utilising the Mitre Att&ack methods and STRIDE for control gap assessments. Culminating in identified risks.
## Conclusion
